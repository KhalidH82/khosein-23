...
const Work = () => {
  return (
      <div className="w-full h-full container px-4 mx-auto">
      <div>
        <p></p>
        <h2>Current Work.</h2>
      </div>
        <div className="w-full h-full flex gap-10 justify-center items-center py-16">
          {experiences.map((experience) => (
            <div className="card w-1/2 h-[300px] bg-gradient-to-b from-ship-cove-400 to-ship-cove-600  text-white">
