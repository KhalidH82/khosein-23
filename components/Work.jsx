      ...
      <div>
        ...
        <div className="w-full h-full flex flex-col lg:flex-row gap-10 justify-center items-center py-16">
          {experiences.map((experience) => (
            <div className="card w-full h-[500px] lg:w-1/2 text-ship-cove-800">
              <div className="card-body">
                ...
                {experience.technologies.map((tech) => (
                    <div class="badge badge-outline p-3 hover:bg-gradient-to-br hover:from-ship-cove-400 hover:to-ship-cove-600 hover:border-white hover:text-white" key={tech}>{ tech }</div>
                ))}
                </div>
                <p className='mt-5'>Productivity</p>
                <div className="flex flex-wrap gap-2">
                {experience.productivity.map((tool) => (
                    <div class="badge badge-outline p-3 hover:bg-gradient-to-br hover:from-ship-cove-400 hover:to-ship-cove-600 hover:border-white hover:text-white" key={tool}>{ tool }</div>
                ))}
                </div>
